...
interface example_if #(
    ...
    property R_Scratch_Register_O_upd_pulse;
        ...
        ##[1:$] (axi4_lite.wready && axi4_lite.wvalid) ##2 R_Scratch_Register_O_upd ##1 !R_Scratch_Register_O_upd;
    endproperty
    ...
    property R_Register_with_Fields_O_upd_pulse;
        ...
        ##[1:$] (axi4_lite.wready && axi4_lite.wvalid) ##2 R_Register_with_Fields_O_upd ##1 !R_Register_with_Fields_O_upd;
    endproperty
